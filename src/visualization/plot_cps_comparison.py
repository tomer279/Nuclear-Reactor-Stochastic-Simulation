"""CPS comparison plotting module.

This module contains classes and functions for creating comprehensive
comparison plots of count rates (CPS) from different numerical methods
and theoretical calculations.

Classes:
    CPSPlotter: Creates CPS comparison plots with dynamic method management
    MethodsTheoreticalPlotter: Creates methods vs theoretical comparison plots

Functions:
    plot_cps_comparison: Create comprehensive comparison plot of CPS values
    plot_methods_vs_theoretical: Create comparison plots of numerical methods
        vs theoretical
"""
