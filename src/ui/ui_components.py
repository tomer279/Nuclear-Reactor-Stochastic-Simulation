...
from src.models.models import (SimulationParameters,
                    ...
                    DeadTimeConfig,
                    DeadTimeAnalysis)
from src.services.services import DeadTimeAnalysisService
...
class ParameterInput:
    ...
    def get_simulation_parameters(self) -> SimulationParameters:
        ...
        simulation_steps = st.number_input(
            "Simulation Steps", 10000, 10_000_000, 100_000)
...
class DeadTimeAnalysisUI:
    ...
    def _add_parameter_info_box(
        ...
        info_text = (
            f"Absorbtion rate: {params.absorption_rate} s⁻¹\n"
            f"Source rate: {params.source_rate} s⁻¹\n"
