...
def plot_cps_comparison(stochastic_cps: list, 
                       ...
                       save_path: Optional[str] = None) -> plt.Figure:
    """
    Create comparison plot of CPS values from stochastic and Euler-Maruyama simulations.
    ...
    # Add the main title
    fig.suptitle("Count Rate Comparison: Stochastic vs Euler-Maruyama",
